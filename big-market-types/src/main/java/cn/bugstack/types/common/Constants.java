...
public class Constants {
    ...
    public  static class RedisKey{
        ...
        public static String ACTIVITY_SKU_KEY = "activity_sku_key";
        public static String ACTIVITY_COUNT_KEY = "activity_count_key";
        public static String STRATEGY_KEY = "big_market_strategy_key_";
        public static String STRATEGY_AWARD_KEY = "big_marker_strategy_award_key_";
        public static String STRATEGY_AWARD_LIST_KEY = "big_marker_strategy_award_list_key_";
        ...
        public static String ACTIVITY_SKU_STOCK_QUERY_KEY = "activity_sku_stock_query_key";
